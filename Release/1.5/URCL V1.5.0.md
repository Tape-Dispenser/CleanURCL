...
|![Tip icon](src/Tip_Icon.png)|*To edit URCL code it is recommended that VSCode is used along with the “URCL & B Syntax Highlighter” extension by RedCMD on the VSCode marketplace.*|
| - | - |
...
|![Tip icon](src/Tip_Icon.png)|*A CPU must be able to translate all these instructions to be 100% compatible with URCL*|
| - | - |
...
|![Tip icon](src/Tip_Icon.png)|*To represent just the Core instructions, only 3 bits are required.*|
| - | - |
...
|![Tip icon](src/Tip_Icon.png)|*Each letter represents 1 bit within each word.*|
| - | - |
